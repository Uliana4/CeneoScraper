...
for opinion in opinions:
    ...
    "recommendation": opinion.select_one('spam.user-post__author-recomendation > recommended').text.strip(),
    "score": opinion.select_one('spam.user-post__score-count').text.strip(),
